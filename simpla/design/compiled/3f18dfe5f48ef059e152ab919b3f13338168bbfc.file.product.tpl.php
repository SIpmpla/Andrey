<?php /* Smarty version Smarty-3.1.18, created on 2015-02-13 12:17:08
         compiled from "simpla\design\html\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2772054dc8566b34980-82437226%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2772054dc8566b34980-82437226',
  'function' => 
  array (
    'category_select' => 
    array (
  ...
  'unifunc' => 'content_54dc856730f6b5_31535943',
  'variables' => 
  array (
    'product' => 0,
    'manager' => 0,
...
<?php if ($_valid && !is_callable('content_54dc856730f6b5_31535943')) {function content_54dc856730f6b5_31535943($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'Q:\\home\\localhost\\www\\simpla\\Smarty\\libs\\plugins\\modifier.replace.php';
if (!is_callable('smarty_modifier_truncate')) include 'Q:\\home\\localhost\\www\\simpla\\Smarty\\libs\\plugins\\modifier.truncate.php';
...
if($('input[name="url"]').val() == generate_url() || $('input[name="url"]').val() == ''){
    ...
    $("#block").change(function(){
        if($(this).attr("checked")){
            url_check = true; // url генерится

        }else{
            url_check = false; // url заблочен
        }});
}
/*block_url*/
...
" / ></li>
                <li><label class=property>Блокировка URL</label><input name="block_url" id="block" type="checkbox" value="1" <?php if ($_smarty_tpl->tpl_vars['product']->value->block_url==1) {?> checked <?php }?> /></li>
